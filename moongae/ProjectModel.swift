...
//    let video:Array<String>
    ...
    init(title: String,  image: Array<String>, startDate: String, endDate: String, tags: Array<String>, summary: String,  coworker: Array<String>, language:String, environment: String, motivation: String, benefit: String, detail:String, createdDate: String, author: String, major: String, commentCount: Int) {
        self.title = title
        self.image = image
...
class ProjectModel {
    ...
    private init() {
        ...
        let project1 = ProjectInfo(title: "공간캡슐", image: ["ui1.png","ui2.png"], startDate: "2018-03-08", endDate: "2018-06-22", tags: ["자바","씨쁠쁠","안드로이드","서버"], summary: "소중한 공간 속 소중한 순간들", coworker: ["김소연", "박예빈", "이재은"], language: "서버 ,java", environment: "안드로이드 스튜디오 3.1.1, SQLite", motivation: "기억을 리마인드 할 수 있는 서비스를 만들고 싶었다.", benefit: "재밌을 것 같다. "
            ,  detail:" ", createdDate:"2018-06-22",  author: "이재은", major: "컴퓨터학과", commentCount:3)

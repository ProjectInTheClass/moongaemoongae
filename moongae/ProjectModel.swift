...
//    let author:Array<String>
    ...
    init(title:String, createdDate:String, summary:String, tags:Array<String>, project_image:String, startDate:String, endDate:String, major:String, author:String, likeCount:Int, commentCount:Int, motivation:String, environment:String, language:String, detail:String, benefit:String) {
        self.title = title
